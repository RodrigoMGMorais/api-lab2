## Como tornar esse script profissional:
...
*Rapidez: Você substitui 5 comandos manuais por apenas um.

*Demonstração de Valor: Em um ambiente de trabalho, apresentar um script de monitoramento básico como esse demonstra que você se preocupa com a estabilidade do ambiente e não apenas com a resolução de erros pontuais.
