...
---
Sim, esse é o comando correto e mais fundamental para realizar um teste de conectividade com o curl.

Ao executar curl -v [https://api.exemplo.com](https://api.exemplo.com), você está dizendo ao seu sistema:

curl: "Inicie uma requisição HTTP/HTTPS".

-v (Verbose): "Seja detalhista! Me mostre tudo o que está acontecendo por trás dos panos".

[https://api.exemplo.com](https://api.exemplo.com): "Este é o alvo".
